                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{route('admin.products.update',['id'=>$product->id])}}"
                                        method="POST"
                                      ...
                                      <div class="form-group">
                                         <div class="col-md-6">
                                            <img src="{{URL::asset($product->photo)}}" alt="photo" width="400" > </td>
                                         </div>
                                      </div>
                                                  ...
                                                  <div class="row">
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                              ...
                                                              <input type="text" value="{{$product->barcode}}" id="barcode"
                                                                     class="form-control"
                                                          ...
                                                          <select class="form-control " name="main_catego_id" id=""
                                                              ...
                                                              @foreach ($main_categories as $category)
                                                                  <option value="{{$category->id}}"
                                                                    @if($category->id==$product->main_catego_id)
                                                                    checked @endif
                                                                    >
                                                                      {{$category->name}}
                                                                  </option>
                                                      ...
                                                      <div class="col-md-12">
                                                          <div class="form-group">
                                                              <label for="projectinput1">  التفاصيل  </label>
                                                               <textarea name="details"  required class="form-control">{{$product->details}}</textarea>
                                                              @error("details")
                                                              <span class="text-danger"> هذا الحقل مطلوب</span>
                                                              @enderror
                                                          </div>
